defmodule TimbereeScenic.Component.Nav do
  ...
  def init(scene, current_scene, opts) do
    ...
    graph =
      ...
      |> dropdown(
        {[
           {"aTimber", TimbereeScenic.Scene.Timber},
           {"Sensor", TimbereeScenic.Scene.Sensor},
           {"Sensor (spec)", TimbereeScenic.Scene.SensorSpec},
           {"Primitives", TimbereeScenic.Scene.Primitives},
           {"Fills", TimbereeScenic.Scene.Fills},
           {"Strokes", TimbereeScenic.Scene.Strokes},
           {"Components", TimbereeScenic.Scene.Components},
           {"Transforms", TimbereeScenic.Scene.Transforms},
           {"Sprites", TimbereeScenic.Scene.Sprites}
         ], current_scene},
        id: :nav,
        translate: {90, 10}
      )
